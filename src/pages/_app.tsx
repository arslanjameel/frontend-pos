...
const App = (props: ExtendedAppProps) => {
  ...
  const contentHeightFixed =
    Component.contentHeightFixed ?? false
  const getLayout =
    Component.getLayout ??
    (page => (
  ...
  const { successFilled, errorFilled } = UseBgColor()
  ...
  return (
    <CacheProvider value={emotionCache}>
      <Head>
        ...
        />
        <meta name='keywords' content='Sharjah' />
        <meta
          name='viewport'
