            ...
            <Box sx={{ mb: 5 }}>
              ...
              <RadioGroup
                ...
                onChange={e =>
                  handleChange(
                    'skin',
                    e.target.value as Settings['skin'],
                  )
                }
              >
                <FormControlLabel
              ...
              <RadioGroup
                ...
                onChange={e =>
                  handleChange(
                    'contentWidth',
                    e.target
                      .value as Settings['contentWidth'],
                  )
                }
              >
                <FormControlLabel
            ...
            <Box sx={{ mb: 5 }}>
              ...
              <RadioGroup
                ...
                onChange={e =>
                  handleChange(
                    'appBar',
                    e.target.value as Settings['appBar'],
                  )
                }
              >
                <FormControlLabel
            ...
            <Box sx={{ mb: 5 }}>
              ...
              <RadioGroup
                ...
                onChange={e =>
                  handleChange(
                    'footer',
                    e.target.value as Settings['footer'],
                  )
                }
              >
                <FormControlLabel
              ...
              <RadioGroup
                ...
                onChange={e => {
                  saveSettings({
                    ...settings,
                    layout: e.target
                      .value as Settings['layout'],
                    lastLayout: e.target
                      .value as Settings['lastLayout'],
                  })
                }}
              >
                <FormControlLabel
                ...
                <RadioGroup
                  ...
                  onChange={e =>
                    handleChange(
                      'verticalNavToggleType',
                      e.target
                        .value as Settings['verticalNavToggleType'],
                    )
                  }
                >
                  <FormControlLabel
