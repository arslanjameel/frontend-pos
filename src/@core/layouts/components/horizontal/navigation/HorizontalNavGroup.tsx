...
const HorizontalNavGroup = (props: Props) => {
  ...
  const popperOffsetHorizontal =
    direction === 'rtl' ? 16 : -16
  const popperPlacement =
    direction === 'rtl' ? 'bottom-end' : 'bottom-start'
  ...
  const MainWrapper = WrapperCondition
    ? ClickAwayListener
    : 'div'
  const ChildWrapper = WrapperCondition ? 'div' : Fragment
  const AnimationWrapper = horizontalMenuAnimation
    ? Fade
    : Fragment
            ...
            <ListItem
              ...
              sx={{
                ...
                ...(!hasParent
                  ? {
                      '&.Mui-selected': {
                        boxShadow: `0px 2px 6px ${hexToRGBA(
