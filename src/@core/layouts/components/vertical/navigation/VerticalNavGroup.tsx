...
const VerticalNavGroup = (props: Props) => {
  ...
  const { direction, navCollapsed, verticalNavToggleType } =
    settings

  // ** Accordion menu group open toggle
  const toggleActiveGroup = (
    item: NavGroup,
    parent: NavGroup | undefined,
  ) => {
    ...
    if (openGroup.includes(item.title)) {
      ...
      if (
        currentActiveGroup.every(elem =>
          groupActive.includes(elem),
        )
      ) {
        ...
        >
          ...
          >
            <ListItemIcon
              sx={{
                ...
                ...(navCollapsed && !navHover
                  ? { mr: 0 }
                  : {}), // this condition should come after (parent && navCollapsed && !navHover) condition for proper styling
          ...
          >
            <VerticalNavItems
              ...
              isSubToSub={
                parent && item.children ? item : undefined
              }
            />
          </Collapse>
        </ListItem>
